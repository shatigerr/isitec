    ...
    $htmlContent = '
        ...
        <body>
            <div class="container">
                ...
                <button><a class="button" href="http://localhost/lib/mailCheckAccount.php?code=' . $code . '&mail=' . $email . '">Confirm Registration</a></button>
    ...
    $htmlContent = '
        ...
        <body>
            <div class="container">
                ...
                <button><a class="button" href="http://localhost/views/resetPassword.php?code=' . $code . '&mail=' . $email . '&status=1">Reset Password</a></button>
